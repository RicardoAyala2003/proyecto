...
const Inicio = () => {
  ...
  return (
    <div className="p-4">
      <h1 className="text-3xl font-bold text-center">Bienvenido a la Página de Inicio</h1>
      ...
      <div className="flex justify-center mt-8">
        <div className="bg-white shadow-md rounded-lg p-6 w-full max-w-2xl text-center">
          <h2 className="text-xl font-semibold mb-4 text-[#002140]">¿Eres nuevo?</h2>
          <p className="mb-4 text-gray-700">
            Te invitamos a registrarte con nosotros y así formar parte de nuestra comunidad de
      ...
      <div className="flex justify-center mt-8">
        <div className="bg-white shadow-md rounded-lg p-6 w-full max-w-2xl text-center">
          <h2 className="text-xl font-semibold mb-4 text-[#002140]">¿Oramos por ti?</h2>
          <p className="mb-4 text-gray-700">
      ...
      <div className="flex justify-center mt-8">
        <div className="bg-white shadow-md rounded-lg p-6 w-full max-w-2xl text-center">
          <h2 className="text-xl font-semibold mb-4 text-[#002140]">Contáctanos</h2>
          <p className="mb-4 text-gray-700">
